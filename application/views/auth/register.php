            ...
            <div class="col-md-4 py-3 d-none d-sm-none d-md-none d-lg-flex">
				...
				<div class="col-lg-8 d-flex">
					<div class="card w-100 my-auto p-1 p-lg-5 border-0">
						<div class="card-body">
							<form action="<?= base_url('submit-daftar') ?>" method="post">
								<h1 class="fw-bold">Daftar</h1>
								<p class="mb-3">Daftarkan diri anda agar mendapatkan informasi-informasi menarik dari <b>Prodia</b>!</p>
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            <label for="inputFName" class="form-label">First Name</label>
                                            <input type="text" class="form-control" id="inputFName" name="fname" required value="<?= @$this->input->post('fname') ?>">
                                        </div>
                                        <div class="col-lg-6 col-12">
                                            <label for="inputLName" class="form-label">Last Name</label>
                                            <input type="text" class="form-control" id="inputLName" name="lname" required value="<?= @$this->input->post('lname') ?>">
                                        </div>
                                    </div>
                                </div>
								<div class="mb-3">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input type="email" class="form-control" id="inputEmail" name="email" required value="<?= @$this->input->post('email') ?>">
                                        </div>
                                        <div class="col-lg-6 col-12">
                                            <label for="inputPhone" class="form-label">Nomor Handphone</label>
                                            <input type="text" class="form-control" id="inputPhone" name="phone" required value="<?= @$this->input->post('phone') ?>">
                                        </div>
                                    </div>
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									<label for="inputCPassword" class="form-label">Konfirmasi Password</label>
									<input type="password" class="form-control" id="inputCPassword" name="confirmPassword" required>
								</div>
								<div class="mb-3">
                                ...
                                <p>Sudah memiliki akun? silahkan <a href="<?= base_url('masuk') ?>">masuk</a></p>
								<button type="submit" class="btn-2 btn-custom float-end">Daftar</button>
							</form>
						</div>
					</div>
				</div>
